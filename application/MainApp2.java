...
public class MainApp2 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			FXMLLoader loader = new FXMLLoader(MainApp2.class.getResource("view/RootLayout.fxml"));
    ...
    public void showLoadFileDialog(AutoSpellingTextArea ta) {
    	try {
			...
			FXMLLoader loader = new FXMLLoader(MainApp2.class.getResource("view/LoadFileLayout.fxml"));
    ...
    public void showEditDistanceDialog(String selectedText) {
    	try {
    		// Load the fxml file and create a new stage for the popup
			FXMLLoader loader = new FXMLLoader(MainApp2.class.getResource("view/EditDistanceLayout.fxml"));
			VBox page = (VBox) loader.load();
			Stage dialogStage = new Stage();
    ...
    public void showMarkovDialog(textgen.MarkovTextGenerator mtg) {
    	try {
    		// Load the fxml file and create a new stage for the popup
			FXMLLoader loader = new FXMLLoader(MainApp2.class.getResource("view/MarkovLayout.fxml"));
